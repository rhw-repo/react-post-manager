      ...
      contains: (rows, id, filterValue) => {
        return rows.filter((row) => {
          ...
          for (const tag of filterValue) {
            // Collect tags present in both filterValue and rowTags
        ...
        Cell: ({ row }) => {
          ...
          return (
            <Link
              ...
              onMouseDown={(e) => {
                /* Prevent focus shift triggering announcement
                table caption */
                e.preventDefault();
              }}
              onClick={(e) => {
                ...
                <tr key={rowKey} {...rowProps} className={styles.tableRow}>
                  {row.cells.map((cell) => {
                    const { key: cellKey, ...cellProps } = cell.getCellProps();
                    {
                      ...
                      although note cells not interactive elements */
                    }
                    return (
                      <td
                        tabIndex={
